...
REM Method 2: If no PIDs found or couldn't kill them, try to kill all Python processes
if %FOUND_PIDS% equ 0 (
    echo No valid PID files found, trying to stop all Python processes related to email validation...
...
echo.
echo You might want to check if any Python processes are still running:
